...
- If PRD.md Section 3 = "location": The location index is implemented. Use `master-prompt.md` (generated by the Setup Wizard) instead of this prompt — it contains the full location setup sequence including Mapbox config, migrations, area seeding, and APP_SETUP marker resolution.
